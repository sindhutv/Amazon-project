...
const today = dayjs(); // Create today's date using DayJS
...
//function that creates HTML for delivery options like shipping
  ...
  deliveryOptions.forEach((deliveryOption) =>{
    ...
    html +=`
      ...
      `
         ...
         return html;   // Return all generated delivery option HTML 
  }

 

document.querySelector('.js-order-summary').innerHTML = cartSummaryHtml; // Insert all cart HTML into the page
